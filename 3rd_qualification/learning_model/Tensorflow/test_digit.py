...
img_color = cv.imread('test1.jpg', cv.IMREAD_COLOR)
...
for contour in contours:
    ...
    probobility = np.amax(predictions)
    ...
    fontScale = 1.2
    cv.putText(img_color, f'{number}, {probobility : 0.2f}', location, font, fontScale, (0, 255, 0), 2)
